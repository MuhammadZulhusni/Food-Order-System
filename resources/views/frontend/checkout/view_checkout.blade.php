                                ...
                                <div class="tab-content h-100" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-cash" role="tabpanel" aria-labelledby="v-pills-cash-tab">
                                        ...
                                        <form action="{{ route('cash_order') }}" method="post">
                                            ...
                                            <button type="submit" class="btn btn-success btn-block btn-lg">PAY <i class="icofont-long-arrow-right"></i></button>
                                        </form>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        // Event listeners for quantity and removal buttons
