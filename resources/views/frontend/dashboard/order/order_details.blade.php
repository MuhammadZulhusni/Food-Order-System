                                    ...
                                    <div class="card">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th class="col-md-1"><label>Image</label></th>
                                                        <th class="col-md-1"><label>Product Name</label></th>
                                                        <th class="col-md-1"><label>Restaurant Name</label></th>
                                                        <th class="col-md-1"><label>Product Code</label></th>
                                                        <th class="col-md-1"><label>Quantity</label></th>
                                                        <th class="col-md-1"><label>Price</label></th> 
                                                    </tr>
                                                </thead>
                                                <tbody>
