...
{{-- Main section for displaying popular restaurants --}}
<section class="section pt-5 pb-5 products-section">
            ...
            @php
                // Fetch all active clients (restaurants) from the database
            ...
            @php
                // Get the first 3 products for the current client to display 'menu' items
                $products = App\Models\Product::where('client_id',$client->id)->limit(3)->get();
                
                // Extract the menu names from the products
                $menuNames = $products->map(function($product){
                return $product->menu->menu_name;
                })->toArray();
                
                // Join the menu names into a single string
                $menuNamesString = implode(' . ',$menuNames);
                
                // Find the first active coupon for the current client
                    ...
                    <div class="item pb-3">
                        ...
                        <div class="p-3 position-relative">
                            ...
                            <div class="list-card-badge">
                                {{-- Display coupon details or a "no coupon" message --}}
                                @if ($coupons)
