...
{{-- All scripts and styles are moved to the bottom of the section for better page load performance --}}
    ...
    $(function() {
      $('.toggle-class').change(function() {
          ...
          $.ajax({
              type: "GET",
              dataType: "json",
              // The URL is changed to /clientchangeStatus to match a shared route,
              // which should be defined in a route group accessible to both admins and clients.
              url: '/admin/clientchangeStatus',
