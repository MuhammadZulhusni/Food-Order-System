...
@section('admin')
{{-- Import jQuery for form validation and the toggle switch functionality --}}
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($product as $key => $item)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td><img src="{{ asset($item->image) }}" alt="Product Image" style="width: 70px; height:40px;"></td>
                                        <td>{{ $item->name }}</td>
...
<script type="text/javascript">
    $(function() {
        // Toggle switch for status update via AJAX
