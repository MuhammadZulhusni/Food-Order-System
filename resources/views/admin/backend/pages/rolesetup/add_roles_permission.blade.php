        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Add Role with Permissions</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                            <li class="breadcrumb-item active">Add Role with Permissions</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-12">
                                    <div>
                                        ...
                                        <div class="form-check mb-3">
                                            ...
                                            <label class="form-check-label" for="formCheck1">Permission All</label>
                                        </div>
                                        <hr>
