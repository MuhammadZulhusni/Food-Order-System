                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" name="best_seller" type="checkbox" id="best_seller" value="1" {{ $product->best_seller == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" name="most_populer" type="checkbox" id="most_populer" value="1" {{ $product->most_populer == 1 ? 'checked' : '' }}>
